        ...
        def information():
            ...
            def StudentRec(event):
                try:
                    ...
                    self.Entry_course.insert(END, selected_tuple[9])
                except IndexError:
                    pass
            ...
            def Search():
                ...
                for row in Std_info_BackEnd.search(self.name.get(), self.fname.get(), self.mname.get(),
                                                   ...
                                                   self.dob.get(), self.gender.get(), self.course.get()):
                    self.listbox.insert(END, row, str(' '))
            ...
            self.Frame_1 = LabelFrame(self.Main_Frame, width=600, height=400, font=('arial', 15, 'bold'), \
                                      relief='ridge', bd=10, fg='green', bg='#3B3720', text='STUDENT INFORMATION ')
            self.Frame_1.grid(row=1, column=0, padx=10)

            self.Frame_2 = LabelFrame(self.Main_Frame, width=750, height=400, font=('arial', 15, 'bold'), \
                                      relief='ridge', fg='green', bd=10, bg='#3B3720', text='STUDENT DATABASE')
            self.Frame_2.grid(row=1, column=1, padx=5)

            self.Frame_3 = LabelFrame(self.master, width=1200, height=100, font=('arial', 10, 'bold'), \
                                      bg='#3B3720', relief='ridge', bd=13)
            self.Frame_3.grid(row=2, column=0, pady=10)

            # ========================================================Labels of Frame_1========================================================
            self.Label_name = Label(self.Frame_1, text='Name', font=('arial', 20, 'bold'), bg='#3B3720', fg='green')
            self.Label_name.grid(row=0, column=0, sticky=W, padx=20, pady=10)
            self.Label_fname = Label(self.Frame_1, text='Father Name', font=('arial', 20, 'bold'), bg='#3B3720',
                                     fg='green')
            self.Label_fname.grid(row=1, column=0, sticky=W, padx=20)
            self.Label_mname = Label(self.Frame_1, text='Mother Name', font=('arial', 20, 'bold'), bg='#3B3720',
                                     fg='green')
            self.Label_mname.grid(row=2, column=0, sticky=W, padx=20)
            self.Label_address = Label(self.Frame_1, text='Address', font=('arial', 20, 'bold'), bg='#3B3720',
                                       fg='green')
            self.Label_address.grid(row=3, column=0, sticky=W, padx=20)
            self.Label_mobno = Label(self.Frame_1, text='Mobile Number', font=('arial', 20, 'bold'), bg='#3B3720',
                                     fg='green')
            self.Label_mobno.grid(row=4, column=0, sticky=W, padx=20)
            self.Label_emailID = Label(self.Frame_1, text='Email ID', font=('arial', 20, 'bold'), bg='#3B3720',
                                       fg='green')
            self.Label_emailID.grid(row=5, column=0, sticky=W, padx=20)
            self.Label_dob = Label(self.Frame_1, text='Date of Birth', font=('arial', 20, 'bold'), bg='#3B3720',
                                   fg='green')
            self.Label_dob.grid(row=6, column=0, sticky=W, padx=20)
            self.Label_gender = Label(self.Frame_1, text='Gender', font=('arial', 20, 'bold'), bg='#3B3720', fg='green')
            self.Label_gender.grid(row=7, column=0, sticky=W, padx=20, pady=10)
            self.Label_course = Label(self.Frame_1, text='Course', font=('arial', 20, 'bold'), bg='#3B3720', fg='green')
            self.Label_course.grid(row=8, column=0, sticky=W, padx=20, pady=10)
            ...
            self.Entry_course = ttk.Combobox(self.Frame_1,
                                             values=('select', 'EEE', 'MECH', 'CIVIL', 'ECE', 'AUTOMOBILE', 'MARINE'), \
                                             font=('arial', 17, 'bold'), textvariable=self.course, width=19)
            self.Entry_course.grid(row=8, column=1, padx=10, pady=5)
